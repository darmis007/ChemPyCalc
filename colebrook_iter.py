...
def CalculateF(diameter,roughness,reynolds):
    ...
    while 1:
        ...
        rightF = - 2 * math.log10(2.51/(reynolds * friction**0.5)+(roughness/1000)/(3.7*diameter)) # Solve Right side of Eqn
...
CFriction = CalculateF(diameter,roughness,reynolds)
...
print("Colebrook-White\t|\t{:.4f}".format(CFriction))
print("--------FRICTION LOSS PER 100M--------")
print("Colebrook-White\t|\t{:.2f}".format(CalculateHL(CFriction,velocity,diameter)))
